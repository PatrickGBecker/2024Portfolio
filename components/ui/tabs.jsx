...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      '!text-[#136955] inline-flex items-center justify-center xl:bg-white p-1 rounded-[30px] dark:md:bg-secondary',
      className
    )}
    {...props}
  />
